...
RSpec.describe Legion::Extensions::Agentic::Social::Social::Client do
  describe '#initialize' do
    it 'creates a default social graph' do
      client = described_class.new
      expect(client.social_graph).to be_a(Legion::Extensions::Agentic::Social::Social::Helpers::SocialGraph)
    end

    it 'accepts an injected social graph' do
      graph = Legion::Extensions::Agentic::Social::Social::Helpers::SocialGraph.new

...
RSpec.describe Legion::Extensions::Agentic::Social::JointAttention::Runners::JointAttention do
  let(:client) { Legion::Extensions::Agentic::Social::JointAttention::Client.new }

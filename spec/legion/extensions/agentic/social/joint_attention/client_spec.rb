...
RSpec.describe Legion::Extensions::Agentic::Social::JointAttention::Client do
  ...
  it 'accepts an injected joint_focus_manager' do
    mgr = Legion::Extensions::Agentic::Social::JointAttention::Helpers::JointFocusManager.new

...
RSpec.describe Legion::Extensions::Agentic::Social::JointAttention::Helpers::AttentionTarget do
  subject(:target) do
  ...
  describe '#initialize' do
    ...
    it 'sets default focus_strength' do
      const = Legion::Extensions::Agentic::Social::JointAttention::Helpers::Constants::DEFAULT_FOCUS
  ...
  describe '#add_attendee' do
    ...
    it 'returns :at_capacity when MAX_ATTENDEES_PER_TARGET is reached' do
      max = Legion::Extensions::Agentic::Social::JointAttention::Helpers::Constants::MAX_ATTENDEES_PER_TARGET
  ...
  describe '#decay' do
    ...
    it 'does not drop focus below FOCUS_FLOOR' do
      floor = Legion::Extensions::Agentic::Social::JointAttention::Helpers::Constants::FOCUS_FLOOR
  ...
  describe '#prune_faded_attendees' do
    it 'removes attendees whose focus is at or below FOCUS_FLOOR' do
      ...
      target.attendees['fading'][:focus] = Legion::Extensions::Agentic::Social::JointAttention::Helpers::Constants::FOCUS_FLOOR

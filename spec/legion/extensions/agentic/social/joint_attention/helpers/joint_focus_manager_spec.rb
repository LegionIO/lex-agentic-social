...
RSpec.describe Legion::Extensions::Agentic::Social::JointAttention::Helpers::JointFocusManager do
  ...
  describe '#create_target' do
    it 'creates a target and returns an AttentionTarget' do
      expect(target).to be_a(Legion::Extensions::Agentic::Social::JointAttention::Helpers::AttentionTarget)
  ...
  describe '#join_target' do
    ...
    it 'enforces MAX_SIMULTANEOUS_TARGETS per agent' do
      max = Legion::Extensions::Agentic::Social::JointAttention::Helpers::Constants::MAX_SIMULTANEOUS_TARGETS
      max.times do |i|
  ...
  describe '#direct_attention' do
    ...
    it 'boosts focus of recipient' do
      ...
      const = Legion::Extensions::Agentic::Social::JointAttention::Helpers::Constants
